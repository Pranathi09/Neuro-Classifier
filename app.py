...
resnet_model.load_state_dict(load("C:/Users/PRANATHI/Downloads/neuralBlack-master/neuralBlack-master/models/bt_resnet50_model.pt", map_location=DEVICE(device)))
resnet_model.eval()
