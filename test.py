...
resnet_model.load_state_dict(torch.load("C:/Users/PRANATHI/Downloads/neuralBlack-master/neuralBlack-master/models/bt_resnet50_model.pt" ,map_location=torch.device('cpu')))
